...
$this->title = Yii::t('app', 'BIOGRAPHY_PAGE_TITLE');
?>
    ...
    <ul class="sidebar-nav">
        ...
        <?php if (Yii::$app->user->isGuest)
            ...
            echo '<li>' . Html::a(Yii::t('app', 'NAV_ADMINISTRATION'), ['/admin/user/profile']) .
                '</li><li>' . Html::a(Yii::t('app', 'NAV_SIGN_OUT'), ['default/sing-out']) . '</li>';
        ?>
        <li>
...
<div class="container cover-container" style="z-index:;">
    <div class="cover" style="background-image: url(/images/biography.jpg); background-position:% 50%;"></div>
    <div class="title-block">
        <div class="row title-row">
            <div class="col-sm-12 title-col">
                <h1 class="header"><?= Yii::t('app', 'BIOGRAPHY_PAGE_TITLE') ?><br></h1>
                <div class="angle">
