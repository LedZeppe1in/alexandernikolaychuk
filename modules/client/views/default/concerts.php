...
<div class="container cover-container" style="z-index:;">
    <div class="cover cover-concert" style="background-image: url(/images/concert.jpg); background-position:% 50%;"></div>
...
<div class="container concerts content-box" id="body">
    <div class="concerts-board">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center" id="concert-items">
