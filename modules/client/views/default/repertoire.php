...
$this->title = Yii::t('app', 'REPERTOIRE_PAGE_TITLE');
?>
...
<div class="container cover-container" style="z-index:;">
    <div class="cover" style="background-image: url(/images/repertoire.jpg); background-position:% 50%;"></div>
    <div class="title-block">
        <div class="row title-row">
            <div class="col-sm-12 title-col">
                <h1 class="header"><?= Yii::t('app', 'REPERTOIRE_PAGE_TITLE') ?><br></h1>
                <div class="angle">
